...
const SolvePage = () => {
  ...
  return (
    <>
      <h1 className="text-3xl capitalize font-bold m-2">
      ...
      <div className="min-h-screen flex flex-col items-start justify-start bg-gradient-to-br from-indigo-100 to-white px-4 py-10">
        ...
        ></textarea>
        <button
          className="bg-green-600 hover:bg-green-700 p-2 rounded-md mt-10 mx-2"
          onClick={() => Submit()}
        >
          Submit
        </button>
              ...
              <>
                ...
                <div className="flex flex-wrap justify-center items-center">
                  <textarea
                    ...
                    placeholder="Code Executed with no Errors"
                  >
                    {msg}
                  </textarea>
                </div>
